...
const mapPositions = [
  { x: 22, y: 24 }, { x: 37, y: 18 }, { x: 55, y: 19 }, { x: 71, y: 25 },
  { x: 84, y: 38 }, { x: 76, y: 57 }, { x: 62, y: 72 }, { x: 48, y: 80 },
  { x: 33, y: 73 }, { x: 18, y: 58 }, { x: 16, y: 40 }, { x: 29, y: 44 },
  { x: 41, y: 34 }, { x: 59, y: 35 }, { x: 69, y: 46 }, { x: 36, y: 58 }
];
